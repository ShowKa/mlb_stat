...
TeamStatistics.prototype.getHititng = function() {
    ...
    // hitting成績
    dest = merge(dest, createStatisticsJson(d.statistics.hitting, "hitting"));
    dest = merge(dest, createStatisticsJson(d.statistics.hitting.onbase, "hitting.onbase"));
    dest = merge(dest, createStatisticsJson(d.statistics.hitting.runs, "hitting.runs"));
    dest = merge(dest, createStatisticsJson(d.statistics.hitting.outcome, "hitting.outcome"));
    dest = merge(dest, createStatisticsJson(d.statistics.hitting.outs, "hitting.outs"));
    dest = merge(dest, createStatisticsJson(d.statistics.hitting.steal, "hitting.steal"));
    return dest;
}
